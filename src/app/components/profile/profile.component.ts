...
export class ProfileComponent implements OnInit {
  ...
  apiUrl = 'https://todoapp-backend-l9t9.onrender.com/api/todos/getuser'; // API endpoint to fetch user details
  delUrl= 'https://todoapp-backend-l9t9.onrender.com/api/todos/deleteuser'
